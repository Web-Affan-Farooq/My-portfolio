...
const Skills = () => {
  ...
  return (
    <section className="text-white p-5 w-[85vw] m-auto flex flex-col flex-nowrap justify-start items-start">
      <div >
      <h1 className='text-[100px] leading-[78px] font-semibold relative right-[10px] max-sm:text-[80px] max-sm:leading-[68px] max-md:text-[80px] max-md:leading-[68px] w-[70vw] max-lg:w-[80vw] max-md:w-full border-2 border-solid borer-white'>My <span className="text-greenlight">Toolbox</span></h1>
      <br />
