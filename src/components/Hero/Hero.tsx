        ...
        <div>
            ...
            <section className='bg-transparent flex flex-row flex-wrap w-full px-5 py-7 md:py-36 justify-between align-middle max-md:flex-col-reverse max-md:justify-start'>
                <div className='p-5 text-white text-left w-3/6 max-md:w-full'>
                    ...
                    <br />
                    <br />
                    <p className='text-gray-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque quod quidem neque aliquam fuga quos, accusamus ex amet debitis fugit ad cum! Nobis quam beatae nam ducimus ipsum nisi temporibus!</p>
                    <br />
                    <Button text="Hire me"/>
                </div>
                <div className='p-5 w-1/2 max-md:w-full'>
                {/* <Image src={'/images/avatar.jpg'} alt='muhammad affan' width={100} height={100} className='rounded-full w-80 h-80 object-cover m-auto'/> */}
