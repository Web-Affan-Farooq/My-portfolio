...
const Hero = () => {
  return (
    <div>
        <br /><br /><br /><br />
        <section className='hero-section bg-transparent flex flex-row flex-wrap w-full px-5 py-7 md:py-36 justify-between align-middle max-md:flex-col-reverse max-md:justify-start'>
