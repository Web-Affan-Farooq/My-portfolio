...
const ServicesData = [
    {
        ...
        specs: ["Responsive frontend with React Or HTML CSS and Typescript .", "Styled with TailwindCSS", "Basic Animations", "Deployment setup on Vercel OR Netlify (without domain)"]
    },
    {
        name: "AI integration",
