...
const HeroText = () => {
  ...
  return (
    <section className="w-full selection:bg-faun selection:text-black pt-[20px] border border-white">
      {/* Desktop View */}
      <div className="m-auto 2xl:w-[85vw] xl:w-full max-md:hidden">
        <div
          className="overflow-hidden 
                ...
                xl:h-[150px]"
        >
          <div className="banner-head flex md:justify-evenly items-center">
            <h1 className="text-white-custom font-firacode font-bold max-sm:text-[40px] sm:text-[50px] md:text-[77px] lg:text-[100px] xl:text-[120px] 2xl:text-[130px]">
              Full-stack
            </h1>
        ...
        >
          <div
            className="banner-head overflow-y-hidden flex 
                lg:justify-evenly
                md:justify-evenly
                items-center"
          >
            ...
            >
              <p className="text-[15px] text-gray-400 tracking-[0.5px]">
                My goal is to{" "}
                <i className="text-white-custom">write maintainable, clean</i>{" "}
                and <i className="text-white-custom">understandable code</i> to
                make the development process enjoyable.
              </p>
            </div>
            <h1
      ...
      <div className="flex flex-col justify-center items-start sm:p-10 max-sm:p-4 max-[400px]:p-0 gap-5 md:hidden">
        ...
        <div className="overflow-hidden text-[20px] sm:w-[400px] max-sm:w-full text-left ">
          <p className="banner-mobile text-[15px] text-gray-400 tracking-[0.5px]">
            My goal is to{" "}
            <i className="text-white-custom">write maintainable, clean</i> and{" "}
            <i className="text-white-custom">understandable code</i> to make the
            development process enjoyable.
          </p>
        </div>
        ...
        <div className="h-[60px] overflow-hidden">
          <a
            href={"/projects"}
            className="banner-mobile flex items-center gap-2"
          >
            <button
              className="bg-white-custom  rounded-[40px] text-black 
