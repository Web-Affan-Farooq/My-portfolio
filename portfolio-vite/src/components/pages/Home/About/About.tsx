...
const MainAbout = () => {
  ...
  return (
    <>
      {/*2xl:w-[85vw] xl:w-[85vw] lg:w-[85vw] md:w-[85vw] sm:w-[85vw]  */}
      <div className="w-full 2xl:px-20 mx-auto flex flex-row flex-nowrap justify-between items-center ">
        <div className="2xl:w-[85vw] 2xl:px-20 xl:w-[85vw] lg:w-[85vw] md:w-[85vw] sm:w-[85vw] mx-auto">
          <div className="h-[80px] xl:h-[110px] 2xl:h-[120px] border border-white overflow-hidden">
            <h1
          ...
          <div className="h-[30px] overflow-hidden border border-white">
      ...
      <div className="sm:w-[85vw] md:w-[85vw] lg:w-[85vw] xl:w-[85vw] 2xl:w-[85vw] 2xl:px-20 p-6 border border-white flex flex-col gap-10 mx-auto">
