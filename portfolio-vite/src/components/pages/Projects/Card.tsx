    ...
    return (
        <div className="flex flex-row flex-nowrap max-md:flex-wrap justify-evenly max-md:justify-start items-center my-5 w-[90vw] max-sm:w-full gap-[20px]">
                ...
                <div className="flex flex-row my-2">
                    {project.project_tags.map((tag, idx) => {
                        return <div className="bg-[#131c2e] text-white-custom flex flex-row flex-nowrap justify-center items-center p-[5px] rounded-full gap-1" key={idx}>
                            <img src={tag.project_tech_image} alt={tag.project_tech_text} width={24} height={24} className="max-sm:w-[25px] max-sm:h-[25px] " />
                        </div>
                    })}
                </div>
            ...
            <div className="w-[350px] h-[200px] rounded-xl overflow-hidden z-10">
                <img src={project.project_images[0]} alt={project.project_name} width={400} height={400} className="w-full h-full object-cover" />
            </div>
        </div>
        ...
        //         <img src={project.project_imgs[0]} alt="project" width={300} height={300} className="object-cover w-full h-full" />
        //     </div>
        ...
        //                     <img src={tag.project_tech_img} alt={tag.project_tech_text} width={24} height={24} className="max-sm:w-[25px] max-sm:h-[25px] " />
        ...
        // <div className='button-container flex items-center gap-2'>
        //     <a href={project.project_github_a} target="_blank">
        //         <button
        //             className='
        //         bg-white-custom text-black
        //         2xl:px-[60px]
        ...
        //         </button>
        //     </a>
        //     <a href={project.project_a} target="_blank">
        //         <button className='bg-white-custom rounded-full'>
