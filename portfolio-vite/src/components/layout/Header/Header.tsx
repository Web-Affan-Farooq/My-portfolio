...
const Header = () => {
  ...
  if (hide) {
    ...
    max-md:items-start"
      ...
      >
        <div
          className="flex flex-row flex-nowrap justify-center items-center gap-[10px] px-[10px] md:px-0 text-white font-semibold font-firacode
      text-[25px] 
      2xl:text-[35px]
      xl:text-[33px]
      lg:text-[31px]"
        ...
        <div
          className="text-[#caf7d2] flex flex-row flex-wrap justify-center items-center 
      md:gap-[43px]
