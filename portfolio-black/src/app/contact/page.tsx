                    ...
                    <form className="grid gap-6" onSubmit={handleSubmit(submitForm)}>
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                />
                                {errors.name && <p className="text-red-700 text-xs mt-2">{errors.name.message}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border border-gray-600 bg-transparent text-white text-sm px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-white placeholder:text-faun"
                                />
                                {errors.email && <p className="text-red-700 text-xs mt-2">{errors.email.message}</p>}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.message && <p className="text-red-700 text-xs mt-2">{errors.message.message}</p>}
                        </div>
