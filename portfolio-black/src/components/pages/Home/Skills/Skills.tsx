        ...
        {Object.keys(skillsData).map((skill, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-6 max-sm:gap-4">
              ...
              {skillsData[skill].map((skill, idx) => (
                <div
                  className="skill-card flex flex-row flex-nowrap justify-center items-center rounded-md w-[50px] h-[50px] max-md:w-[35px] max-md:h-[35px] bg-gray-900 cursor-pointer hover:rotate-10 hover:scale-[1.2] hover:shadow-lg transition-all duration-300 ease-in-out"
                  key={idx}
                >
                  <Image
                    src={skill.logo}
